function [Descien_use,Pixel_ID] = ROI_Detect3(TSNEProjection, i, Potential_Location, memMap, Diff_Projection, dataSize,Area_Size)
...
if size(positions,1)>=Area_Size
    SubBlock_Signal = gpuArray(memMap.Data.Feature(positions, 1:dataSize(1, 2)));
    ...
    if size(Pixel_ID,1)>=Area_Size
        ...
        SubBlock_Signal = gpuArray(memMap.Data.Feature(Pixel_ID, 1:dataSize(1, 2)));
